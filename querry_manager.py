...
if __name__ == '__main__':
    ...
    # req_q = 1
    # res_q = 1
    pr_pr = multiprocessing.Process(target=process_manager, args=(main_req_q, main_res_q, llm_req_q, llm_res_q, onto_req_q, onto_res_q))
    pr_llm = multiprocessing.Process(target=llm_manager, args=(llm_req_q, llm_res_q))
    pr_onto = multiprocessing.Process(target=ontology_manager, args=(onto_req_q, onto_res_q))
